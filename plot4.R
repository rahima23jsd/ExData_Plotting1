...
datadays$Voltage <- as.numeric(as.character(datadays$Voltage))
datadays$Global_reactive_power <- as.numeric(as.character(datadays$Global_reactive_power))

# plot
png(filename = "plot4.png",width = 480, height = 480)
par(mfrow=c(2,2))

with(datadays, plot(fulltime, Global_active_power, xlab="", ylab="Global Active Power", type="l"))

with(datadays, plot(fulltime, Voltage, xlab="datetime", ylab="Voltage", type="l"))
...
with(datadays, plot(fulltime, Global_reactive_power, xlab="datetime", ylab="Global_reactive_power", type="l"))
